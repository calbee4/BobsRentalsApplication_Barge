...
The main application can be found in [main_application.py](main_application.py). The provided classes are customer.py, rental.py, rental_equipment.py, rental_shop.py, ski.py, and snowboard.py.
